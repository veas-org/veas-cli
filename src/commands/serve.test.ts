...
describe('serve command', () => {
  ...
  describe('authentication failures', () => {
    it('should exit when not authenticated', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Please run "veas login" first')
      );
  ...
  describe('server initialization failures', () => {
    it('should handle initialization errors', async () => {
      mockMCPServer.initialize.mockRejectedValueOnce(
  ...
  describe('configuration display', () => {
    it('should display MCP client configuration', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('"veas"')
      );
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('"command": "veas"')
      );
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('"args": ["serve"]')
      );
    });
  });
