...
describe('PAT Commands', () => {
  ...
  describe('createPAT', () => {
    it('should create a PAT successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        'http://localhost:3000/api/cli/auth/pat/create',
        {
          method: 'POST',
          headers: {
    ...
    it('should handle custom scopes', async () => {
      ...
      (prompts.text as any).mockResolvedValueOnce('Custom Token')
        .mockResolvedValueOnce('read, write, admin');
  ...
  describe('listPATs', () => {
    it('should list PATs successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        'http://localhost:3000/api/cli/auth/pat',
        {
          method: 'GET',
          headers: {
            'Authorization': 'Bearer test-cli-token',
