 ...
 */
export function expectMCPError(response: MCPResponse, expectedCode?: number, expectedMessage?: string | RegExp): void {
  expect(response).toBeDefined()
  expect(response.jsonrpc).toBe('2.0')
 ...
 */
export function expectParameterValidation(error: any, parameterName: string, expectedMessage?: string): void {
